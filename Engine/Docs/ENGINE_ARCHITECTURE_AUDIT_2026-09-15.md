...
| R4 — Share play lifecycle and durability | Extract an isolated PlaySession used by Workbench Game View and standalone player; source authoring state is immutable during play. Correct A09/A10 and register relevant persistence tests from A11. Close with start/pause/restart/stop, one dynamic object, player collision/gravity and durable save receipts. |
