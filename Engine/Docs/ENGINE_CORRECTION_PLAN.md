...
Continue with **R4 shared play lifecycle, streaming recovery and persistence** after the completed R1–R3 correction batches. Visible gizmo widget acceptance remains open with the UI owner and does not become an R4 engine prerequisite. No new general audit or generator task is required.
