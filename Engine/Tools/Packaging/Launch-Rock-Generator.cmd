...
set "inspection_args="
if exist "%package_dir%bin\Assets\inspection.json" set inspection_args=--inspection "%package_dir%bin\Assets\inspection.json"
if exist "%package_dir%UserData\inspection.json" set inspection_args=--inspection "%package_dir%UserData\inspection.json"
set "library_args="
if exist "%package_dir%bin\Assets\RockPresets" set library_args=--rock-library "%package_dir%bin\Assets\RockPresets"
set "model_args="
...
"%package_dir%bin\engine_workbench.exe" --rock "%package_dir%UserData\rock.json" --save-inspection "%package_dir%UserData\inspection.json" %inspection_args% %library_args% %model_args% %*
exit /b %errorlevel%
