...
int main(int argc,char** argv)try{
    ...
    rejects([&]{generateTerrain(recipe,{},rock,{},[]{return true;});});rejects([&]{generateTerrain(recipe,{INT64_MAX,0},rock,{});});auto invalid=recipe;invalid.version=4;rejects([&]{generateTerrain(invalid,{},rock,{});});
