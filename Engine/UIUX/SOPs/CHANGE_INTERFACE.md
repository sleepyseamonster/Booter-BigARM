...
3. State the small acceptance contract. Check overlap, resize behavior, keyboard/mouse capture, scrolling, and whether hidden UI performs document bookkeeping. Explain any world/persistence impact before implementation.
