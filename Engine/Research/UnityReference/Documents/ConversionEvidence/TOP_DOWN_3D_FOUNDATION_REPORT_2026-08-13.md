...
The user's first visual review found that this baseline was too subtle and began too far from the playable camera frame. The strengthened tuning made dust unavoidable, then the user's second review requested a small reduction. The current balance places the exponential-squared fog's 50% visibility point at roughly 26 world units in the clearest field and roughly 18 world units in the naturally dustiest field. Close motes, broad veils, contrast loss, warm filtering, and glow remain active throughout normal play, with their emission, opacity, and post-processing eased modestly to improve nearby readability.
