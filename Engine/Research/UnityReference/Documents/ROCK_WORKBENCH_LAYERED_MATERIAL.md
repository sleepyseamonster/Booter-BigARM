...
- Steep faces receive irregular, seed-stable islands of that shale using a wall-correct projection.
...
- Underside shale, dispersed side- and top-shale patches, cracks, sparse side grit, crack halos, mineral patches, worn shine, and upward dust remain layers of one material; they do not create submeshes or decal GameObjects.
- Smooth and mineral patches alter roughness while the rock remains non-metallic.

The workbench exposes eight direct surface-language controls:
...
- **Side Shale Patches** — strength of broad, irregular shattered-plate islands mixed into steep faces. It reuses the underside material without stretching it across walls.
