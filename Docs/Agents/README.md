...
This directory contains durable contracts and working surfaces for persistent repo-level agents.

## Active Manager

- [Gottspan](./Gottspan/README.md) — repo manager, Unity project manager, multi-agent coordinator, and final integrator.
